      ...
      <ul className="mt-6 text-xs -ml-8">
        <Link to="/" className='no-underline'>
          <li className="px-4 py-4 hover:bg-gray-200 flex flex-col items-center cursor-pointer">
            <FiHome size={24} className="text-gray-600 mb-1" /> {/* Dashboard icon */}
            <span className="text-gray-600">Dashboard</span>
          </li>
        </Link>
        <li className="px-4 py-4 hover:bg-gray-200 flex flex-col items-center cursor-pointer">
          <FiUsers size={24} className="text-gray-600 mb-1" /> {/* Org. icon */}
          <span className="text-gray-600">Org.</span>
        </li>
        <Link to="calendar" className='no-underline'>
          <li className="px-4 py-4 hover:bg-gray-200 flex flex-col items-center cursor-pointer">
            <FiCalendar size={24} className="text-gray-600 mb-1" /> {/* Calendar icon */}
            <span className="text-gray-600">Calendar</span>
          </li>
        </Link>
        <li className="px-4 py-4 hover:bg-gray-200 flex flex-col items-center cursor-pointer">
          <FiTruck size={24} className="text-gray-600 mb-1" /> {/* Parkings icon */}
          <span className="text-gray-600">Parkings</span>
        </li>
        <Link to="recurit"  className='no-underline'>
          <li className="px-4 py-4 hover:bg-gray-200 flex flex-col items-center cursor-pointer">
